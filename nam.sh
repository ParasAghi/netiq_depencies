...
yum install bc lsof ksh yum-utils nss-softokn-freebl.i686  ncurses-libs.i686 bind-utils  createrepo unzip zip net-tools nmap libgcc*.i686 libncurses* ncurses-libs chkconfig rsyslog rsyslog-gnutls binutils patch apr apr-util libtool-ltdl unixODBC net-snmp-libs net-snmp iproute initscripts -y
